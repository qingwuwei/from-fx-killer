...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateBilingualMetadata(
    'Yongxianli 博客 - 外汇交易知识与市场洞察丨涌现力丨外汇交易员培训、全职交易员培训',
    'Yongxianli Blog - Forex Trading Insights & Market Analysis丨Yongxianli丨Forex Trader Training, Full-Time Trader Training',
